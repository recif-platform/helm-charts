...
# Usage: curl -sSL https://raw.githubusercontent.com/sciences44/agentic-platform/main/deploy/install.sh | bash
set -euo pipefail
...
if [ -f "deploy/kind/setup.sh" ]; then
  ...
  git clone https://github.com/sciences44/agentic-platform.git recif-platform
